...
public class MethodDeclarationComparerTest {
    ...
    public void testSimpleRemoval() {
        ...
        Assert.assertTrue(new MethodDeclarationComparer().wasParameterRemoved(oldParams, newParams));
    }
    ...
    public void testSimpleParamRename() {
        ...
        Assert.assertFalse(new MethodDeclarationComparer().wasParameterRemoved(oldParams, newParams));
    }
